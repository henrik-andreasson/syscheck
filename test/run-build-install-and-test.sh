...
test/bats-core/bin/bats --formatter=junit  --timing test/help.bats                  | tee -a  $ABS_TESTRESULT_PATH/test_1_help.txt
ts1_end=$(date +"%s")
...
test/bats-core/bin/bats --formatter=junit  --timing test/help-scripts.bats          | tee -a  $ABS_TESTRESULT_PATH/test_2_help_scripts.txt
ts2_end=$(date +"%s")
...
test/bats-core/bin/bats --formatter=junit  --timing test/test-scripts.bats          | tee -a $ABS_TESTRESULT_PATH/test_3_scripts.txt
ts3_end=$(date +"%s")
...
$SUDO --formatter=junit  --timing test/bats-core/bin/bats test/test-syscheck-console.bats | tee -a  $ABS_TESTRESULT_PATH/test_4_console.txt
ts4_end=$(date +"%s")
